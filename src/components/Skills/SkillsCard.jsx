...
function SkillsCard() {
  return (
    <section
      ...
      className="py-32 px-6 relative bg-amber-50/20"
    >
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-24 gap-6">
          <div>
            <div className="flex items-center gap-2 text-amber-500 font-mono text-[10px] uppercase tracking-[0.4em] mb-4">
              <Briefcase size={14} aria-hidden="true" /> My Journey
            </div>
            <h2
              id="skills-heading"
              className="text-5xl md:text-6xl font-earthlight tracking-tight text-zinc-900 uppercase"
            >
              Skills
            </h2>
          </div>
        ...
        <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 list-none p-0">
          {skills.map((skill) => (
